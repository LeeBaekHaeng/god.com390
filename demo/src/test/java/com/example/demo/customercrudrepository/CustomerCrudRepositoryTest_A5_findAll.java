...
@SpringBootTest
class CustomerCrudRepositoryTest_A5_findAll {

	private static final Logger log = LoggerFactory.getLogger(CustomerCrudRepositoryTest_A5_findAll.class);

	private final CustomerCrudRepository repository;

	@Autowired
	public CustomerCrudRepositoryTest_A5_findAll(CustomerCrudRepository repository) {
